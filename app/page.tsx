            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6">
                ...
                <div className="flex-1 space-y-4">
                  ...
                  {/* Social Links */}
                  <div className="flex gap-3" role="list" aria-label="Tautan Media Sosial">
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Link 
                            ...
                            aria-label="Kunjungi profil GitHub Rendi Ichtiar"
                            role="listitem"
                          >
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Link 
                            ...
                            rel="noopener noreferrer"
                            className="flex items-center justify-center w-9 h-9 rounded-full border border-border/40 bg-background/80 text-muted-foreground transition-colors hover:bg-primary/5 hover:text-primary hover:border-primary/40"
                            aria-label="Kunjungi profil LinkedIn Rendi Ichtiar"
                            role="listitem"
                          >
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Link 
                            ...
                            className="flex items-center justify-center w-9 h-9 rounded-full border border-border/40 bg-background/80 text-muted-foreground transition-colors hover:bg-primary/5 hover:text-primary hover:border-primary/40"
                            aria-label="Kirim email ke rendichpras@gmail.com"
                            role="listitem"
                          >
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Link 
                            ...
                            rel="noopener noreferrer"
                            className="flex items-center justify-center w-9 h-9 rounded-full border border-border/40 bg-background/80 text-muted-foreground transition-colors hover:bg-primary/5 hover:text-primary hover:border-primary/40"
                            aria-label="Kunjungi profil Instagram Rendi Ichtiar"
                            role="listitem"
                          >
                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
