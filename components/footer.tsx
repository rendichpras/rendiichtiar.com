  ...
  return (
    <li>
      <Button
        ...
        variant="ghost"
        size="icon"
        className={`h-9 w-9 rounded-xl border border-border/30 bg-card/30 text-muted-foreground hover:border-border/50 hover:bg-card/50 hover:text-primary focus-visible:ring-2 focus-visible:ring-primary/40 ${className ?? ""}`}
        aria-label={label}
        title={label}
      >
        <Link
            ...
            <nav aria-label="Social media">
              <ul className="flex items-center justify-center gap-3 sm:justify-end">
                <SocialLink
                  ...
                  label={messages.footer.social.github}
                >
                  <SiGithub
                ...
                <SocialLink
                  ...
                  label={messages.footer.social.linkedin}
                >
                  <SiLinkedin
                ...
                <SocialLink
                  ...
                  label={messages.footer.social.instagram}
                >
                  <SiInstagram
